 ...
 * Currently, it contains the following data structures:
 * . readyQueue: holds a queue of ready processes
 * . finishedQueue: holds a queue of finished processes
 * . runningProcess: holds the process currently running
 * @author htrefftz
 */
public class RRScheduler {
     ...
     */
    public RRScheduler(Processor processor) {
